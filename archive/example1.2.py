...
def frequency_query():
	...
	for line in desc:
		...
		lab = ttk.Label(main_frame.mainframe, text=str(line[0]))
		lab.pack(side=TOP)
	...
	for row in samcount:
		...
		lab = ttk.Label(main_frame.mainframe, text=row)
...
class main_frame:
	...
	def __init__(self, root):
		...
		self.search_but.pack(side=LEFT, fill=BOTH, expand=1)
		...
		self.file_but.pack(side=LEFT, fill=BOTH, expand=1)

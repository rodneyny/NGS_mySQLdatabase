...
def frequency_query():
	...
	lab = ttk.Label(query.queryframe, text=header)
	...
	for row in samcount:
		...
		lab = ttk.Label(query.queryframe, text=row)
		lab.pack(side=BOTTOM)
		# row = ' | '.join(str(e) for e in row)
		# row =row + "\n"
